...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TeamRishav/RishavMusicBot",
)
...
)  # Example:- https://t.me/RishavMusic
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/RishavSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @RishavStringBot
