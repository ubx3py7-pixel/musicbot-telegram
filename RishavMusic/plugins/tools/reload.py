...
from RishavMusic.utils.database import get_authuser_names, get_cmode
from RishavMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from RishavMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Rishav.stop_stream(message.chat.id)
    except:
        pass
