...
import config
from RishavMusic import Carbon, YouTube, app
from RishavMusic.core.call import Rishav
from RishavMusic.misc import db
from RishavMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from RishavMusic.utils.exceptions import AssistantErr
from RishavMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from RishavMusic.utils.inline.playlist import close_markup
from RishavMusic.utils.pastebin import Rishavbin
from RishavMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Rishav.force_stop_stream(chat_id)
